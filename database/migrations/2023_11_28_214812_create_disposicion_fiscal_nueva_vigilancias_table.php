...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('disposicion_fiscal_nueva_vigilancias', function (Blueprint $table) {
            ...
            $table->string('numeroDocumento',1500)->nullable();
            $table->string('siglasDocumento',1500)->nullable();
            $table->date('fechaDocumento')->nullable();
            $table->text('asunto')->nullable();
            $table->string('respondea',1500)->nullable();
            $table->string('evaluacion',1500)->nullable();
