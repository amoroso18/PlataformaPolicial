...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('disposicion_fiscal_nueva_vigilancias', function (Blueprint $table) {
            ...
            $table->string('numeroDocumento',5000)->nullable();
            $table->string('siglasDocumento',5000)->nullable();
            $table->date('fechaDocumento')->nullable();
            $table->string('asunto',5000)->nullable();
            $table->string('respondea',5000)->nullable();
            $table->string('evaluacion',5000)->nullable();
            $table->string('conclusiones',5000)->nullable();
