...
<div id="miapp">
    ...
    <div class="form-label-group">
        <label class="form-label">Filtrar búsqueda</label>
    </div>
    <div class="form-control-wrap mt-2">
        <input type="text" v-model="databusqueda.nombres" class="form-control form-control-lg" placeholder="Ingresa el departamento" />
    </div>
    <div class="form-control-wrap mt-2">
        <input type="text" v-model="databusqueda.apellido_paterno" class="form-control form-control-lg" placeholder="Ingresa la provincia" />
    </div>
    <div class="form-control-wrap mt-2">
        <input type="text" v-model="databusqueda.apellido_materno" class="form-control form-control-lg" placeholder="Ingresa el distrito" />
    </div>
    <div class="form-control-wrap mt-2">
        <input type="text" v-model="databusqueda.apellido_materno" class="form-control form-control-lg" placeholder="Ingresa la dirección" />
    </div>
    <div class="form-group mt-3">
        <button  class="btn btn-lg btn-primary btn-block" v-on:click={manualFormulario()}>Iniciar búsqueda</button>
    </div>
